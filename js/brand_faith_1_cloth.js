...
$('.option').click(function () {
    ...
    if (selected != 5) {
        ...
        // $('.complete').attr("onclick", "location='brand_faith_2_cloth.html'")
...
function countScore() {
    ...
    switch (sum) {
        // sum=0  
        default:
            location.href = 'brand_faith_2_cloth.html#_0';
            break;
        // sum=1
        case 1:
            location.href = 'brand_faith_2_cloth.html#20';
            break;
        // sum=2
        case 2:
            location.href = 'brand_faith_2_cloth.html#40';
            break;
        // sum=3  
        case 3:
            location.href = 'brand_faith_2_cloth.html#60';
            break;
        // sum=4
        case 4:
            location.href = 'brand_faith_2_cloth.html#80';
            break;
        // sum=5
        case 5:
            location.href = 'brand_faith_2_cloth.html#100';
            break;
    }
    // if (sum > -1) {
    //     $('.complete').attr('onchange', "location='brand_faith_2_cloth.html#_0'");
    //     if (sum > 0) {
    //         $('.complete').attr('onchange', "location='brand_faith_2_cloth.html#20'");
    //         if (sum > 1) {
    //             $('.complete').attr('onchange', "location='brand_faith_2_cloth.html#40'");
    //             if (sum > 2) {
    //                 $('.complete').attr('onchange', "location='brand_faith_2_cloth.html#60'");
    //                 if (sum > 3) {
    //                     $('.complete').attr('onchange', "location='brand_faith_2_cloth.html#80'");
    //                     if (sum > 4) {
    //                         $('.complete').attr(
    //                             'onchange',
    //                             "location='brand_faith_2_cloth.html#100'"
    //                         );
    //                     }
    //                 }
    //             }
