...
$('.answer').click(function () {
    ...
    if (click > 0) {
        ...
        setTimeout(function () {
            ...
            $('.answer_card img').attr('src', 'img/drink/drink_doutor-3.png')
        }, 400)
        if (click > 1) {
            $('.answer_card').addClass('animate__flipOutY')
            setTimeout(function () {
                ...
                $('.answer_card')
                    ...
                    .removeClass('animate__flipOutY').addClass('animate__flipInY')
                $('.answer_card img').attr('src', 'img/drink/drink_br31-2.png')
            }, 400)
            if (click > 2) {
                $('.answer_card').addClass('animate__flipOutY')
                setTimeout(function () {
                    ...
                    $('.answer_card')
                        .addClass('answer_card_width')
                        .removeClass('animate__flipOutY').addClass('animate__flipInY')
                    $('.answer_card img').attr('src', 'img/drink/drink_haagen-dazs-1.png')
                }, 400)
                if (click > 3) {
                    $('.answer_card').addClass('animate__flipOutY')
                    setTimeout(function () {
                        ...
                        $('.answer_card')
                            .removeClass('answer_card_width')
                            .removeClass('animate__flipOutY').addClass('animate__flipInY')
                        $('.answer_card img').attr('src', 'img/drink/drink_pepsi-4.png')
                    }, 400)
                }
                if (click > 4) {
                    click = -1
                    ...
                    setTimeout(function () {
                        ...
                        $('.answer_card')
                            .removeClass('animate__flipOutY').addClass('animate__flipInY')
                        $('.answer_card img').attr('src', 'img/drink/drink_starbucks-4.png')
                    }, 400)
                }
            }
        }
...
$('.game').eq(2)
        .css('cursor','pointer')
        .click(function () {
            window.open('brand_faith_0_food.html', '_blank');})
        .mouseenter(function () {
            $(this).css('filter', 'drop-shadow(0px 0px 5px rgba(50, 125, 215, 1))').css('transform', 'scale(1.05)')})
        .mouseleave(function () { $(this).css('filter', 'unset').css('transform', 'scale(1)') })
